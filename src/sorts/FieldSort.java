...
final public class FieldSort extends Sort {
    private MaxHeapSort heapSorter;

    private int middle;
    private int sizeThreshold = 27;
    
    public FieldSort(Delays delayOps, Highlights markOps, Reads readOps, Writes writeOps) {
        super(delayOps, markOps, readOps, writeOps);
        
        this.setSortPromptID("Field");
        this.setRunAllID("Field Sort");
        this.setReportSortID("Field Sort");
